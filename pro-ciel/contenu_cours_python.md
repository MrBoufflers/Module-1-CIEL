# Cours Python — BAC PRO CIEL Terminale
## Contenu textuel complet pour pro-ciel.netlify.app

---

# ANALYSE DE FAISABILITÉ

## La question : 2 cours + 1 contrôle, est-ce que ça tient ?

**Mon avis : oui, c'est faisable et même bien calibré.** Voici pourquoi :

### Ce qui joue en ta faveur :
- Les élèves connaissent déjà JavaScript → ils comprennent les variables, conditions, boucles, fonctions. On ne repart pas de zéro, on traduit.
- Python est plus simple que JS sur beaucoup de points (pas de var/let/const, pas d'accolades, pas de point-virgule) → la transition est fluide
- Le format 1h30 cours/exo + 1h30 TP est idéal pour Python : c'est un langage qui se prête parfaitement au "je code, je vois le résultat"

### Ce qui demande de l'attention :
- L'indentation obligatoire en Python est un piège pour les élèves qui viennent de JS (ils oublient ou mettent des accolades par réflexe)
- Les listes/dictionnaires + fonctions en 1h30 de cours, c'est dense → il faut être efficace
- Le TP 2 doit être assez cadré pour que les plus lents finissent

### Structure retenue :
- **Cours 1** : Les bases de Python (syntaxe, variables, types, input/print, conditions, boucles) — Transition JS → Python
- **Cours 2** : Structures de données et fonctions (listes, dictionnaires, fonctions, modules) — Vers l'autonomie
- **Contrôle** : 3h, deux sujets (G1/G2), couvre les deux cours

### Si tu avais un 3ème cours (option B) :
- Cours 3 : Mini-projet guidé (script complet combinant tout) → type scanner réseau, analyseur de logs, ou gestionnaire d'inventaire
- Le contrôle serait alors plus ambitieux

**Verdict** : 2 cours + contrôle, c'est le bon format. Les élèves connaissent la logique de programmation grâce au JS, on se concentre sur la syntaxe Python et ses spécificités.

---

# SITES D'ENTRAÎNEMENT PYTHON RECOMMANDÉS

## Choix principal : learnpython.org/fr/

**Pourquoi ce site :**
- Interface en français
- Exécution de code Python directement dans le navigateur
- Progression par chapitres (Hello World → Variables → Conditions → Boucles → Fonctions → Listes → Dictionnaires)
- Gratuit, sans inscription
- Exercices interactifs avec validation automatique
- Couvre exactement le périmètre des deux cours

## Ressource complémentaire : Pyvert (diraison.github.io/Pyvert/)

**Pourquoi ce site en complément :**
- 128 exercices Python dans le navigateur
- Bouton "Exécuter" + bouton "Vérifier la réponse"
- Correction automatique après 10 tentatives
- Progression de difficulté adaptée aux lycéens
- Parfait pour du travail en autonomie

## Outil de pratique libre : Python Online (programiz.com/python-programming/online-compiler/)

**Pour le TP libre :**
- Éditeur Python en ligne, rien à installer
- Les élèves peuvent tester leurs scripts immédiatement
- Interface épurée, pas de distraction

## Alternative gamifiée : France-IOI (france-ioi.org)

**Si tu veux varier :**
- Plateforme française, axée algorithmique
- Supports Python, progression par niveaux
- Plus orienté "problèmes à résoudre" que "cours structuré"
- Bon complément pour les élèves rapides

---

# COURS 1 : LES BASES DE PYTHON
...
# CONTRÔLE — PYTHON (3h)
## Deux sujets : G1 et G2

---

## SUJET G1 : "NetWatch — Outil de surveillance réseau"

### Durée : 3h | Barème total : 60 points

---

### Mise en situation :
Vous êtes technicien(ne) en cybersécurité chez NetSecure. L'équipe vous demande de développer un outil Python en ligne de commande appelé "NetWatch" qui aide les techniciens à surveiller et analyser les équipements réseau.

---

### Partie 1 — Variables, types et affichage (12 points)

**Question 1 (3 pts)** — Traduisez le code JavaScript suivant en Python :

```javascript
let serveur = "SRV-PROD-01";
let ip = "10.0.0.50";
let port = 443;
let actif = true;
...
**Question 2 (3 pts)** — Écrivez un script Python qui demande à l'utilisateur une quantité en Mégabits par seconde (Mbps) et la convertit en :
- Mégaoctets par seconde (Mo/s) → diviser par 8
- Gigabits par seconde (Gbps) → diviser par 1000
Affichez les résultats avec des f-strings.

**Question 3 (3 pts)** — Quel est le type de chaque variable ci-dessous ? Répondez sans exécuter le code.
...
**Question 4 (3 pts)** — Écrivez un script qui demande à l'utilisateur un nombre de secondes et affiche la conversion en heures, minutes et secondes. Exemple : 3672 secondes → "1h 1min 12s"

Indice : opérateur // (division entière) et % (modulo).

---

### Partie 2 — Conditions et boucles (16 points)

**Question 5 (4 pts)** — Écrivez un script qui demande à l'utilisateur un code de réponse HTTP (ex : 200, 404, 500) et affiche le message correspondant :
- 200 → "OK — Succès"
...
**Question 6 (4 pts)** — Écrivez un script qui affiche tous les nombres de 1 à 100 qui sont :
- Divisibles par 3 → affiche "Fizz"
- Divisibles par 5 → affiche "Buzz"
- Divisibles par 3 ET 5 → affiche "FizzBuzz"
- Sinon → affiche le nombre

(C'est le célèbre exercice "FizzBuzz", un classique des entretiens d'embauche en informatique !)

**Question 7 (4 pts)** — Écrivez un script de connexion sécurisée qui :
1. Définit un identifiant correct ("admin") et un mot de passe correct ("Ciel2026!")
2. Demande à l'utilisateur son identifiant et son mot de passe
3. L'utilisateur a 3 tentatives maximum
4. Après 3 échecs, affiche "Compte bloqué"
5. Si connexion réussie, affiche "Bienvenue admin !"

**Question 8 (4 pts)** — Écrivez une boucle qui analyse la liste suivante et affiche uniquement les adresses IP privées (commençant par 10., 172.16 à 172.31, ou 192.168) :

```python
adresses = ["8.8.8.8", "192.168.1.1", "10.0.0.1", "172.217.20.46",
            "172.16.0.1", "1.1.1.1", "192.168.0.254", "172.20.10.5"]
```

---

### Partie 3 — Listes et dictionnaires (16 points)

**Question 9 (4 pts)** — Soit la liste suivante :

```python
logs = [
    "2026-02-20 08:15 LOGIN admin SUCCESS",
    "2026-02-20 08:16 LOGIN guest FAILED",
    "2026-02-20 08:20 LOGIN admin SUCCESS",
    "2026-02-20 09:01 LOGIN hacker FAILED",
    "2026-02-20 09:02 LOGIN hacker FAILED",
    "2026-02-20 09:03 LOGIN hacker FAILED",
    "2026-02-20 10:30 LOGIN user1 SUCCESS",
]
```

Écrivez un script qui :
a) Compte le nombre total de tentatives de connexion
b) Compte les succès et les échecs
c) Affiche les lignes contenant "FAILED"

Indice : utilisez la méthode "FAILED" in log pour vérifier si un mot est dans une chaîne.

**Question 10 (6 pts)** — Créez une liste de dictionnaires représentant 5 alertes de sécurité :

Chaque alerte a : un id, un type (intrusion/malware/phishing/ddos), une source_ip, une gravite (1 à 5), un timestamp, et un statut (nouvelle/traitee/ignoree).

Puis écrivez :
a) Une fonction `alertes_critiques(alertes)` qui retourne les alertes de gravité >= 4
b) Une fonction `compter_par_type(alertes)` qui retourne un dictionnaire avec le nombre d'alertes par type
c) Un affichage formaté de toutes les alertes non traitées, triées par gravité décroissante

**Question 11 (6 pts)** — Créez un dictionnaire qui associe des noms de serveurs à leurs caractéristiques :

```python
serveurs = {
    "web01": {"ip": "192.168.1.10", "os": "Ubuntu", "cpu": 85, "ram": 72, "disque": 45},
    "db01": {"ip": "192.168.1.20", "os": "Debian", "cpu": 45, "ram": 90, "disque": 78},
    "mail01": {"ip": "192.168.1.30", "os": "CentOS", "cpu": 30, "ram": 55, "disque": 92},
    "backup01": {"ip": "192.168.1.40", "os": "Ubuntu", "cpu": 10, "ram": 25, "disque": 95},
}
```

Écrivez un script qui :
a) Affiche les serveurs dont le CPU est > 80% (alerte CPU)
b) Affiche les serveurs dont la RAM est > 85% (alerte RAM)
c) Affiche les serveurs dont le disque est > 90% (alerte disque)
d) Génère un résumé : "X serveurs surveillés, Y alertes détectées"

---

### Partie 4 — Fonctions et modules (16 points)

**Question 12 (4 pts)** — Écrivez une fonction `valider_ip(ip)` qui prend une chaîne de caractères et retourne True si c'est une adresse IP valide, False sinon.

Critères de validation :
- Exactement 4 octets séparés par des points
...
**Question 13 (4 pts)** — Écrivez une fonction `generer_mot_de_passe(longueur, avec_speciaux=True)` qui :
- Génère un mot de passe aléatoire de la longueur demandée
- Inclut des caractères spéciaux si avec_speciaux est True
- Utilise les modules random et string
- Garantit au moins 1 majuscule, 1 minuscule, 1 chiffre

**Question 14 (4 pts)** — Écrivez une fonction `analyser_logs(logs)` qui prend la liste de logs de la Question 9 et retourne un dictionnaire avec :
- Le nombre total de tentatives
- Le nombre de succès
- Le nombre d'échecs
- La liste des utilisateurs uniques
- L'utilisateur avec le plus de tentatives échouées

**Question 15 (4 pts)** — Écrivez un programme complet "NetWatch Mini" qui propose un menu :
1. Valider une adresse IP
2. Générer un mot de passe sécurisé
3. Analyser les logs de connexion
4. Quitter

Le programme utilise les fonctions des questions 12, 13 et 14. Il boucle tant que l'utilisateur ne choisit pas 4.

---
---

## SUJET G2 : "CyberGuard — Assistant de sécurité"
...
### Mise en situation :
Vous êtes en stage dans l'équipe SOC (Security Operations Center) de NetSecure. Votre tuteur vous demande de créer un outil Python appelé "CyberGuard" pour aider les analystes à traiter les incidents de sécurité.
...
```javascript
let utilisateur = "analyst01";
let role = "SOC Analyst";
let niveau = 2;
let certifie = false;

console.log("Utilisateur : " + utilisateur);
console.log("Rôle : " + role + " (Niveau " + niveau + ")");
...
**Question 2 (3 pts)** — Écrivez un script Python qui demande à l'utilisateur un débit en octets par seconde (o/s) et le convertit en :
- Ko/s (diviser par 1024)
- Mo/s (diviser par 1024²)
- Gb/s (multiplier par 8, diviser par 1 000 000 000)
Affichez les résultats avec des f-strings, arrondis à 2 décimales.

**Question 3 (3 pts)** — Sans exécuter le code, donnez le résultat de chaque print() :
...
**Question 4 (3 pts)** — Écrivez un script qui demande une date au format "JJ/MM/AAAA" et affiche séparément le jour, le mois et l'année, avec le nom du mois en toutes lettres.

Indice : utilisez .split("/") et une liste de noms de mois.

---

### Partie 2 — Conditions et boucles (16 points)

**Question 5 (4 pts)** — Écrivez un script qui demande un numéro de port et indique le protocole et le niveau de risque :
- Port 21 (FTP) → "⚠️ Risque élevé — transfert non chiffré"
- Port 22 (SSH) → "✅ Risque faible — connexion chiffrée"
- Port 23 (Telnet) → "🔴 Risque critique — aucun chiffrement"
- Port 80 (HTTP) → "⚠️ Risque moyen — trafic non chiffré"
- Port 443 (HTTPS) → "✅ Risque faible — trafic chiffré"
- Port 3389 (RDP) → "⚠️ Risque élevé — cible fréquente d'attaques"
- Autre → "ℹ️ Risque inconnu — port non référencé"

**Question 6 (4 pts)** — Écrivez un script qui génère un "tableau de bord" des ports en scannant les ports de 1 à 30. Pour chaque port, s'il est dans la liste des ports connus [21, 22, 23, 25, 80], affichez son nom. Sinon, n'affichez rien. À la fin, affichez le nombre de ports connus trouvés sur le total scanné.

**Question 7 (4 pts)** — Écrivez un script de "quiz cybersécurité" :
- Posez 5 questions à choix multiples sur la sécurité (ex : "Que signifie HTTPS ? a) ... b) ... c) ...")
- L'utilisateur répond par la lettre (a, b, c)
- Le programme compte les bonnes réponses
- À la fin, affiche le score et un commentaire (0-1: "À revoir", 2-3: "Pas mal", 4-5: "Expert !")

**Question 8 (4 pts)** — Analysez la liste suivante de tentatives de connexion et détectez les attaques par force brute (3 tentatives échouées ou plus depuis la même IP en moins d'une minute — ici simplifiées dans la même liste) :

```python
tentatives = [
    {"ip": "192.168.1.50", "resultat": "succes"},
    {"ip": "45.33.12.78", "resultat": "echec"},
    {"ip": "45.33.12.78", "resultat": "echec"},
    {"ip": "45.33.12.78", "resultat": "echec"},
    {"ip": "192.168.1.51", "resultat": "succes"},
    {"ip": "89.123.45.67", "resultat": "echec"},
    {"ip": "45.33.12.78", "resultat": "echec"},
    {"ip": "89.123.45.67", "resultat": "echec"},
    {"ip": "89.123.45.67", "resultat": "echec"},
]
...
Affichez les IP suspectes (3 échecs ou plus) avec le nombre de tentatives échouées.

---

### Partie 3 — Listes et dictionnaires (16 points)

**Question 9 (4 pts)** — Soit la liste suivante de mots de passe compromis :

```python
mots_de_passe = ["admin123", "password", "Tr0ub4dor&3", "123456", "qwerty",
                 "P@ssw0rd!", "letmein", "abc123", "CielPro2026!", "iloveyou"]
```

Écrivez un script qui analyse chaque mot de passe et affiche s'il est "faible" ou "acceptable" selon ces critères :
- Faible : moins de 8 caractères OU ne contient que des lettres OU ne contient que des chiffres
- Acceptable : 8+ caractères ET contient à la fois des lettres et des chiffres

**Question 10 (6 pts)** — Créez une liste de dictionnaires représentant 6 incidents de sécurité :

Chaque incident a : un id, une date, un type (phishing/ransomware/intrusion/fuite_donnees/ddos), une description, un impact (faible/moyen/eleve/critique), et un resolu (True/False).

Puis écrivez :
a) Une fonction `incidents_non_resolus(incidents)` qui retourne les incidents non résolus
b) Une fonction `compter_par_impact(incidents)` qui retourne un dictionnaire avec le nombre d'incidents par niveau d'impact
c) Un affichage sous forme de "tableau de bord" avec les statistiques et la liste des incidents critiques non résolus

**Question 11 (6 pts)** — Créez un dictionnaire représentant les règles d'un pare-feu :

```python
regles_firewall = [
    {"id": 1, "action": "ALLOW", "source": "192.168.1.0/24", "dest": "ANY", "port": 80, "protocole": "TCP"},
    {"id": 2, "action": "ALLOW", "source": "192.168.1.0/24", "dest": "ANY", "port": 443, "protocole": "TCP"},
    {"id": 3, "action": "DENY", "source": "ANY", "dest": "192.168.1.100", "port": 22, "protocole": "TCP"},
    {"id": 4, "action": "ALLOW", "source": "10.0.0.0/8", "dest": "192.168.1.100", "port": 22, "protocole": "TCP"},
    {"id": 5, "action": "DENY", "source": "ANY", "dest": "ANY", "port": 23, "protocole": "TCP"},
    {"id": 6, "action": "ALLOW", "source": "ANY", "dest": "ANY", "port": 53, "protocole": "UDP"},
]
```

Écrivez un script qui :
a) Affiche toutes les règles de type "DENY"
b) Compte le nombre de règles ALLOW vs DENY
c) Affiche les règles qui concernent le port 22 (SSH)
d) Demande à l'utilisateur un port et affiche les règles correspondantes

---

### Partie 4 — Fonctions et modules (16 points)

**Question 12 (4 pts)** — Écrivez une fonction `force_mot_de_passe(mdp)` qui analyse un mot de passe et retourne un tuple (score, commentaire) :
- +1 point si >= 8 caractères
- +1 point si contient des majuscules ET des minuscules
- +1 point si contient des chiffres
- +1 point si contient des caractères spéciaux
- +1 point si >= 12 caractères
Score 0-1: "Très faible", 2: "Faible", 3: "Moyen", 4: "Fort", 5: "Excellent"

**Question 13 (4 pts)** — Écrivez une fonction `chiffrer_cesar(message, decalage)` qui :
- Prend un message et un nombre de décalage
- Décale chaque lettre de l'alphabet du nombre indiqué
- Laisse les caractères non alphabétiques inchangés
- Retourne le message chiffré

Exemple : chiffrer_cesar("HELLO", 3) → "KHOOR"

Indice : utilisez ord() pour obtenir le code ASCII d'un caractère et chr() pour l'inverse.

**Question 14 (4 pts)** — Écrivez une fonction `detecter_brute_force(tentatives, seuil=3)` qui prend la liste de la Question 8 et retourne un dictionnaire des IP suspectes avec leur nombre d'échecs. Seules les IP ayant >= seuil échecs sont retournées.

**Question 15 (4 pts)** — Écrivez un programme complet "CyberGuard Mini" qui propose un menu :
1. Tester la force d'un mot de passe
2. Chiffrer/Déchiffrer un message (César)
3. Analyser les tentatives de connexion
4. Quitter

Le programme utilise les fonctions des questions 12, 13 et 14.
...
if actif:
    ...
    print("Statut : Hors ligne")
```

**Q2 (3 pts)** :
```python
mbps = float(input("Débit en Mbps : "))
mo_s = mbps / 8
gbps = mbps / 1000
print(f"{mbps} Mbps = {mo_s:.2f} Mo/s")
print(f"{mbps} Mbps = {gbps:.4f} Gbps")
```

**Q3 (3 pts)** : a: int, b: str, c: float, d: bool, e: list, f: dict, g: NoneType

**Q4 (3 pts)** :
```python
secondes_total = int(input("Nombre de secondes : "))
...
**Q5 (4 pts)** :
```python
code = int(input("Code HTTP : "))
if code == 200:
    print("OK — Succès")
elif code == 301:
    print("Moved Permanently — Redirection")
elif code == 403:
    print("Forbidden — Accès refusé")
elif code == 404:
    print("Not Found — Page introuvable")
elif code == 500:
    print("Internal Server Error — Erreur serveur")
else:
    print("Code inconnu")
```
...
```python
id_correct = "admin"
mdp_correct = "Ciel2026!"
tentatives = 0

while tentatives < 3:
    identifiant = input("Identifiant : ")
    mot_de_passe = input("Mot de passe : ")
    if identifiant == id_correct and mot_de_passe == mdp_correct:
        print("Bienvenue admin !")
        break
    else:
        tentatives += 1
        print(f"Échec. {3 - tentatives} tentative(s) restante(s)")
...
print("Adresses privées :")
for ip in adresses:
    octets = ip.split(".")
    premier = int(octets[0])
    deuxieme = int(octets[1])
    if premier == 10:
        print(f"  {ip} (Classe A privée)")
    elif premier == 172 and 16 <= deuxieme <= 31:
        print(f"  {ip} (Classe B privée)")
    elif premier == 192 and deuxieme == 168:
        print(f"  {ip} (Classe C privée)")
```
...
total = len(logs)
succes = sum(1 for log in logs if "SUCCESS" in log)
echecs = sum(1 for log in logs if "FAILED" in log)

print(f"Total tentatives : {total}")
...
```python
alertes = [
    {"id": 1, "type": "intrusion", "source_ip": "45.33.12.78", "gravite": 5, "timestamp": "2026-02-20 09:15", "statut": "nouvelle"},
    {"id": 2, "type": "malware", "source_ip": "192.168.1.50", "gravite": 4, "timestamp": "2026-02-20 10:30", "statut": "traitee"},
    {"id": 3, "type": "phishing", "source_ip": "89.123.45.67", "gravite": 3, "timestamp": "2026-02-20 11:00", "statut": "nouvelle"},
    {"id": 4, "type": "ddos", "source_ip": "103.45.67.89", "gravite": 5, "timestamp": "2026-02-20 14:00", "statut": "nouvelle"},
    {"id": 5, "type": "intrusion", "source_ip": "45.33.12.80", "gravite": 4, "timestamp": "2026-02-20 15:30", "statut": "ignoree"},
]

# a)
def alertes_critiques(alertes):
    return [a for a in alertes if a["gravite"] >= 4]

# b)
def compter_par_type(alertes):
    compteur = {}
    for a in alertes:
        t = a["type"]
...
# c)
non_traitees = [a for a in alertes if a["statut"] != "traitee"]
non_traitees.sort(key=lambda a: a["gravite"], reverse=True)
for a in non_traitees:
    print(f"[Gravité {a['gravite']}] {a['type']} — {a['source_ip']} — {a['statut']}")
```
...
for nom, infos in serveurs.items():
    if infos["cpu"] > 80:
        print(f"🔴 CPU {nom} : {infos['cpu']}%")
        nb_alertes += 1
    if infos["ram"] > 85:
        print(f"🟠 RAM {nom} : {infos['ram']}%")
        nb_alertes += 1
    if infos["disque"] > 90:
        print(f"🔴 Disque {nom} : {infos['disque']}%")
        nb_alertes += 1

print(f"\n{len(serveurs)} serveurs surveillés, {nb_alertes} alertes détectées")
```
...
def generer_mot_de_passe(longueur, avec_speciaux=True):
    ...
    for _ in range(longueur - len(mdp)):
...
def analyser_logs(logs):
    ...
    for log in logs:
        ...
        if resultat == "SUCCESS":
            ...
            echecs += 1
            echecs_par_user[user] = echecs_par_user.get(user, 0) + 1

    pire_user = max(echecs_par_user, key=echecs_par_user.get) if echecs_par_user else None
...
**Q15 (4 pts)** : Menu while True avec les fonctions Q12-Q14, break sur choix 4.

---

## Correction G2 — CyberGuard

(Même structure, corrections disponibles sur demande — les questions suivent la même logique que G1 avec un contexte cybersécurité différent)

### Points clés des corrections G2 :

**Q1** : Traduction JS→Python directe, True au lieu de true, f-strings.

**Q3** : type(a)=str, int(a)+b=13, a*b="101010", len(a)=2, bool("")=False, bool(0)=False, bool("False")=True (chaîne non vide!)
...
parties = date.split("/")
jour = parties[0]
mois_num = int(parties[1])
annee = parties[2]
mois_noms = ["", "janvier", "février", "mars", "avril", "mai", "juin",
             "juillet", "août", "septembre", "octobre", "novembre", "décembre"]
print(f"{jour} {mois_noms[mois_num]} {annee}")
```

**Q8** — Détection brute force :
```python
compteur_echecs = {}
for t in tentatives:
    if t["resultat"] == "echec":
        ip = t["ip"]
        compteur_echecs[ip] = compteur_echecs.get(ip, 0) + 1

print("IP suspectes (brute force) :")
for ip, nb in compteur_echecs.items():
    if nb >= 3:
        print(f"  🔴 {ip} — {nb} tentatives échouées")
```

**Q13** — Chiffrement César :
```python
def chiffrer_cesar(message, decalage):
    ...
    for c in message:
        if c.isalpha():
            ...
            nouveau = chr((ord(c) - base + decalage) % 26 + base)
            resultat += nouveau
        else:
            resultat += c
    return resultat
...
# GUIDE D'INTÉGRATION POUR LE SITE REACT

## Structure des pages à créer :

```
/cours/python-bases         → Cours 1 (cours/exo + TP)
/cours/python-structures    → Cours 2 (cours/exo + TP)
/controle/python-g1         → Contrôle G1
/controle/python-g2         → Contrôle G2
```

## Composants à utiliser :
- Heading : titres de sections
- Card : blocs de contenu (concepts, mémos, comparaisons JS/Python)
- PracticalWork : sections TP avec consignes
- CodeSnippet : blocs de code Python ET JavaScript côte à côte pour les comparaisons
- ComparisonBox : composant spécial pour les tableaux JS vs Python (déjà utilisé dans les modules existants)
- Composant accordéon : pour les corrections et les "aide si besoin"

## Éléments visuels suggérés :
- Tableaux de comparaison JS/Python dans des Card avec deux colonnes colorées (bleu JS / vert Python)
- Les "ATTENTION" et "DANGER" dans des Card rouges (surtout pour l'indentation et le UPDATE/DELETE sans WHERE)
- Le mémo JS→Python en card fixe ou accessible via un bouton
- Les corrections dans des blocs repliables

## Liens externes à intégrer :
- learnpython.org/fr/ → lien principal dans les deux cours
- diraison.github.io/Pyvert/ → exercices supplémentaires
- programiz.com/python-programming/online-compiler/ → éditeur pour les TP

## Continuité avec les modules existants :
Ces cours remplacent/complètent les PythonModule1_Bases.jsx et PythonModule2_Structures.jsx déjà sur le site. Le contenu est plus détaillé, avec des corrections complètes et des contrôles. Les composants React existants (CodeSnippet, ComparisonBox, Card, PracticalWork) sont réutilisables tels quels.
