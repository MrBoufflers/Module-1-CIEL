...
export const courseData = {
  troncCommun: [
    ...
    },
    {
      ...
      icon: '🎓',
      ref: { competence: 'C04 - Analyser une structure matérielle et logicielle.', savoirs: 'S3.1, S3.5, S4.11' },
    ...
    },
    {
      ...
      title: 'Intro Windows',
      icon: '🖥️',
      ref: { competence: "C09 - Installer les éléments d'un système...", savoirs: 'S4.11, S4.12' },
    ...
    },
    {
      ...
      title: 'Software & Web',
      icon: '🌐',
      ref: { competence: 'C04 & D1', savoirs: 'S3.1, S3.2, S5.1' },
    ...
    },
    {
      ...
      title: 'Git et Github',
      icon: '🔀',
      ref: { competence: 'C03, C01, C08.', savoirs: 'S2.10, S2.7, S1.2' },
  ...
  premiere: [
    {
      ...
      icon: '🏗️',
      ref: { competence: 'C03, C01, C08.', savoirs: 'S1.2, S5.1, S2.10, S1.4' },
    ...
    },
    {
      ...
      title: 'Javascript',
      icon: '🏗️',
      ref: { competence: 'C08, C03, C01', savoirs: 'S1.2, S5.1, S2.10, S1.4' },
    ...
    },
    {
      ...
      icon: '🐍',
      ref: { competence: 'C08 - Coder', savoirs: 'S5.1, S5.5' },
    ...
    },
    {
      ...
      icon: '🗃️',
      ref: { competence: 'C08 - Coder, C04 - Analyser', savoirs: 'S5.1, S3.1' },
  ...
  terminale: [
    {
      ...
      title: 'Jeux Video',
      icon: '🎮',
      ref: { competence: 'C08 - Coder, C04 - Analyser une structure matérielle et logicielle', savoirs: 'S5.5, S5.1, S3.1, S3.6' },
