    ...
    <div className="space-y-12 prose prose-lg max-w-none prose-headings:font-bold prose-h2:border-b prose-h2:pb-2">
      ...
      <section>
        ...
        <Card className="bg-red-50 border-red-300 not-prose">
            ...
            <p>Cette situation s'explique par la nature du recrutement et du programme. Les commissions d'admission accordent un poids très important aux résultats scolaires dans les matières scientifiques fondamentales comme les mathématiques et la physique (jusqu'à 70% de l'évaluation pour le BUT GEII).<a href={sourceLinks[42]} target="_blank" rel="noopener noreferrer" className="text-blue-600 no-underline hover:underline">[source]</a> Or, le programme du bac professionnel, bien qu'excellent sur le plan technique, n'accorde pas le même volume horaire à ces disciplines théoriques. De plus, la concurrence est extrêmement élevée : plus de 2300 candidats pour moins de 200 places pour le BUT GEII <a href={sourceLinks[42]} target="_blank" rel="noopener noreferrer" className="text-blue-600 no-underline hover:underline">[source]</a>, et près de 5000 candidats pour 125 places pour le BUT Informatique.</p>
            <p>Pour un bachelier professionnel, même excellent, l'accès direct en BUT est donc un véritable défi. Il ne doit être envisagé que par des élèves disposant d'un dossier scolaire exceptionnel et ne doit en aucun cas constituer l'unique stratégie d'orientation. La voie la plus réaliste et stratégique pour atteindre ce niveau d'étude est de viser une admission en 2ème ou 3ème année de BUT après avoir brillamment réussi un BTS. Les IUT prévoient en effet des passerelles pour les titulaires de diplômes Bac+2.<a href={sourceLinks[39]} target="_blank" rel="noopener noreferrer" className="text-blue-600 no-underline hover:underline">[source]</a></p>
        </Card>
      ...
      <section>
        ...
        <ul className="list-disc list-inside">
            ...
            <li><strong>Le BUT représente une voie d'excellence, mais doit être considéré comme un objectif à moyen terme.</strong> Les données d'admission de 2024 montrent un accès direct quasi nul pour les bacheliers professionnels à l'IUT Lyon 1. La stratégie la plus pertinente est de viser une admission en 2ème ou 3ème année de BUT après avoir excellé en BTS.</li>
            <li><strong>La Licence Professionnelle est l'étape de spécialisation idéale après un BTS.</strong> Elle permet d'atteindre un niveau Bac+3, d'acquérir une expertise pointue (cybersécurité, administration avancée des réseaux) et d'accéder à des postes mieux rémunérés et à plus hautes responsabilités.</li>
        </ul>
